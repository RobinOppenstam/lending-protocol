  ...
  return (
    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
      <div className="text-center space-y-8">
        ...
        {/* Connect Wallet CTA */}
        <div className="bg-white dark:bg-slate-800 rounded-2xl p-8 card-shadow">
          <div className="space-y-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-12">
          {features.map((feature, index) => (
            <div 
              key={index}
              className="bg-white dark:bg-slate-800 rounded-xl p-6 card-shadow hover-scale"
            >
        ...
        {/* Stats Preview */}
        <div className="bg-gradient-to-r from-blue-50 to-purple-50 dark:from-slate-800 dark:to-slate-700 rounded-xl p-6 mt-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="text-center">
              ...
              <div className="text-sm text-slate-600 dark:text-slate-400">Markets Available</div>
            </div>
            <div className="text-center">
              <div className="text-2xl font-bold text-green-600">0-15%</div>
              <div className="text-sm text-slate-600 dark:text-slate-400">APY Range</div>
            </div>
            <div className="text-center">
              <div className="text-2xl font-bold text-purple-600">80%</div>
              <div className="text-sm text-slate-600 dark:text-slate-400">Max LTV</div>
            </div>
          </div>
        </div>
      </div>
